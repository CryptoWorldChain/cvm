...
//            TipCost gasCosts = blockchainConfig.getGasCost();
...
//                    gasCost = gasCosts.getSTOP();
                		System.out.println("STOP -- VM.java 192");
                    break;
                case SUICIDE:
            			System.out.println("SUICIDE -- VM.java 195");
...
//                    }
                    break;
                case SSTORE:
        				System.out.println("SSTORE -- VM.java 210");
...
//                    gasCost += chunkUsed * gasCosts.getSHA3_WORD();
                ...
                case CALLDATACOPY:
                case RETURNDATACOPY:
					System.out.println("RETURNDATACOPY -- VM.java 261");
//                    gasCost += calcMemGas(gasCosts, oldMemSize,
//                            memNeeded(stack.peek(), stack.get(stack.size() - 3)),
//                            stack.get(stack.size() - 3).longValueSafe());
                    break;
                case CODECOPY:
					System.out.println("CODECOPY -- VM.java 267");
//                    gasCost += calcMemGas(gasCosts, oldMemSize,
//                            memNeeded(stack.peek(), stack.get(stack.size() - 3)),
//                            stack.get(stack.size() - 3).longValueSafe());
                    break;
                case EXTCODESIZE:
					System.out.println("EXTCODESIZE -- VM.java 273");
//                    gasCost = gasCosts.getEXT_CODE_SIZE();
                    break;
                case EXTCODECOPY:
					System.out.println("EXTCODECOPY -- VM.java 277");
...
//                            stack.get(stack.size() - 4).longValueSafe());
                ...
                case DELEGATECALL:
                case STATICCALL:
					System.out.println("STATICCALL -- VM.java 286");
...
//                    gasCost += adjustedCallGas.longValueSafe();
                    break;
                case CREATE:
					System.out.println("CREATE -- VM.java 327");
...
//                            memNeeded(stack.get(stack.size() - 2), stack.get(stack.size() - 3)), 0);
                ...
                case LOG3:
                case LOG4:
					System.out.println("LOG4 -- VM.java 336");
...
//                            calcMemGas(gasCosts, oldMemSize, memNeeded(stack.peek(), stack.get(stack.size() - 2)), 0);
                    break;
                case EXP:
					System.out.println("EXP -- VM.java 352");
...
//                    byte[] encoded = sha3(buffer);
                ...
                case DUP13: case DUP14: case DUP15: case DUP16:{
                		System.out.println("DUP13 -- VM.java 967");
...
//                    program.step();
                ...
                case SWAP13: case SWAP14: case SWAP15: case SWAP16:{
            			System.out.println("SWAP13 -- VM.java 978");
...
//                    program.step();
                ...
                case DELEGATECALL:
                case STATICCALL: {
                		System.out.println("STATICCALL -- VM.java 1204");
